...
class UserRegisteration extends Component{
    ...
    state = {name: '', email: '', password: '', errMsg: '', successMsg: ''}
    ...
    onSubmitUSerData = async (event) => {
        ...
        const response = await fetch(`${process.env.REACT_APP_API_URL}/api/users/register`, options)
            ...
            <div className='user-registartion-container'>
               ...
               <form className='form-container' onSubmit={this.onSubmitUSerData}>
                    ...
                    <div className='mt-2 mb-2'>
                        ...
                        <input type="text" value={email} onChange={this.onChangeEmail} id="inputemail" className="form-control" aria-describedby="passwordHelpBlock" placeholder='Enter Your email' />
                    </div>
                    <div className='mt-2 mb-2'>
                        <label htmlFor="inputPassword5" className="form-label">Password</label>
                        <input type="password" value={password} onChange={this.onChangePassword} id="inputPassword5" className="form-control" aria-describedby="passwordHelpBlock" placeholder='Enter your Password'/>
                    </div>
...
export default withNavigation(UserRegisteration)